...
<template>
    <div class="font-sans" :class="{'sm:border-l relative': index % 2 === 1}">
        <div class="flex">
            <div>
                <img :src="logoUrl" :alt="title" class="w-22 h-22 mr-4 border border-x4 dark:border-0 bg-white" style="border-radius: 30%"/>
            </div>
            <div class="flex-1">
