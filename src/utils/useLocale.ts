...
const translations = {
    ...
    "tirsik_description": {
        "en": "The interactive Kurdish dictionary. Read, discuss, review, complain, and joke about everything on Tirsik.",
        "ku": "Ferhenga înteraktîf a kurdî. Di tirşikê de li ser her tiştî bixwîne, nîqaşan, rexneyan, gilîyan, henekan bike.",
    },
    ...
    "li_hev_bine_description": {
        "en": "A game for kids. Kids can learn basic concepts with this game!",
